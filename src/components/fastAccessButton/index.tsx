...
export const FastAccessButton = ({ icon, pageName }: FastAccessButtonProps) => {
  return (
    <div className="bg-GOLD_MAIN h-[124px] w-full rounded-lg p-6 flex flex-col justify-between transition-all group cursor-pointer opacity-95 ">
